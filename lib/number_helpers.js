...
(function() {
  ...
  NumberHelpers = (function() {
    ...
    NumberHelpers.number_to_rounded = function(float, opts) {
      var _precision, ref, value;
      if (opts == null) {
        opts = {};
      }
      _precision = (ref = opts.precision) != null ? ref : 3;
      value = float.toString().split('e');
      value = Math.round(+(value[0] + 'e' + (value[1] ? +value[1] + _precision : _precision)));
      value = value.toString().split('e');
      value = +(value[0] + 'e' + (value[1] ? +value[1] - _precision : -_precision));
      return this.number_with_precision(value, opts);
    };
